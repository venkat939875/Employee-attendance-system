...
export default function EmployeeDashboard() {
  ...
  const getStatus = (r: any) => {
    if (!r || !r.loginTime) return "Absent";
  ...
  return (
    <main
      className="relative min-h-screen p-6 md:p-10 bg-cover bg-center"
      style={{ backgroundImage: "url('/images/empdash.jpg')" }}
    >
